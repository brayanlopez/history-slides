...
class R {
  ...
  update(e = !1) {
    ...
    s &&
      this.bubbleSlideContrastClassToElement(s, this.Reveal.getRevealElement()),
      setTimeout(() => {
...
class L {
  ...
  autoAnimateElements(e, t, i, s, a) {
    ...
    if (
      ...
      (e.className.match(w) || [""])[0] === (t.className.match(w) || [""])[0] &&
            ...
            (t.progressBarSlide = document.createElement("div")),
              ...
              (t.scrollTriggerElements = t.scrollTriggers.map((i, s) => {
                ...
                return (
                  ...
                  (n.style.top =
                    (i.range[0] - e.range[0]) * this.progressBarHeight + "px"),
                  (n.style.height =
...
function $(n, o) {
  ...
  function nt() {
    return t(Y.wrapper, m + ':not(.stack):not([data-visibility="uncounted"])');
  }
  function rt() {
    ...
    if ((pt(), p && !1 !== A.autoSlide)) {
      ...
      i
        ...
        !J ||
          ...
          ((G = setTimeout(() => {
            "function" == typeof A.autoSlideMethod ? A.autoSlideMethod() : St(),
              gt();
          }, J)),
          (Q = Date.now())),
        w && w.setPlaying(-1 !== G);
  ...
  const Nt = {
    ...
    stopEmbeddedContent: () => ee.stopEmbeddedContent(p, { unloadIframes: !1 }),
    showPreview: Me,
    hidePreview: Be,
    ...
    getProgress: function () {
      ...
      if (p) {
        ...
        if (e.length > 0) {
          let i = 0.9;
          t += (p.querySelectorAll(".fragment.visible").length / e.length) * i;
        }
      }
